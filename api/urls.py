...
from .views import StudentView,TutorView,CreateStudentView, GetStudentView, SubjectList, GetStudentViewUsername, UpdateStudentView, UpdateTutorView, CreateTutorView, GetTutorViewUsername, GetTutorView, LogoutView
urlpatterns = [
